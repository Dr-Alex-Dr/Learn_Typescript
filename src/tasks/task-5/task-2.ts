...
class ApiProvider { 
    ...
    public static getSomeOther(): ApiResponse<SomeOtherResponse[], MetaTrackMessage> {
        return {
            data: SomeExternalApi.getSomeOther(),
            meta: {
                trackId: "Sqny0mSDCByB",
                trackerUrl: "someTrackerUrl",
            }
        };
    }
